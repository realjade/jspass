...
APP_NAME = 'jspass'
APP_INST_NAME = '20121106'

# 命令行参数
parser = argparse.ArgumentParser(description=u'Run an jspass FastCGI server')
...
if __name__ == '__main__':
    ...
    daemon = JSPassDaemon(gen_pidfile(args.port))
